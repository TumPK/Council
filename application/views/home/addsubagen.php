...
<div id="body" class="width">
  <section id="content" class="two-column with-right-sidebar">  
        ระเบียบวาระที่ <?php echo $_SESSION['noagen1'].": ".$_SESSION['detailagen1']; ?>
        
<form class="form-inline" action="<?php echo site_url('Template/addsubagen2'); ?>" method="post"> 
  <?php for ($i=0;$i<5;$i++) { ?>
...
<?php    
    if($_SESSION['noagen1']==$_SESSION['stop']){
       echo '<button class="btn btn-default" type="submit"  id="al"><a href="'.site_url('template/').'"><i class="fa fa-submit"></i>เสร็จสิ้น</a></button>';
    }
    else{
