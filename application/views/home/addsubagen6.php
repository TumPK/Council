...
<div id="body" class="width">
  <section id="content" class="two-column with-right-sidebar">  
        ระเบียบวาระที่ <?php echo $_SESSION['noagen6'].": ".$_SESSION['detailagen6']; ?>
<form class="form-inline" action="<?php echo site_url('Template/addsubagen7'); ?>" method="post"> 
  <?php for ($i=0;$i<5;$i++) { ?>
 ...
 ?> 
  <?php    
    if($_SESSION['noagen2']==$_SESSION['stop']){
       echo '<button class="btn btn-default" id="al" type="submit" ><a href="'.site_url('template/').'"><i class="fa fa-submit"></i>เสร็จสิ้น</a></button>';
    }
    else{
 ...
 ?>
      <!-- <a href="<?php echo site_url('template/success');?>" class='fancybox fancybox.iframe'><button type="submit" class="btn btn-default">ถัดไป</button></a> --><!-- 
     <button type="submit" class="btn btn-default">บันทึก</button> --></form>  
  </section>