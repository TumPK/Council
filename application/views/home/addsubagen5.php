...
<div id="body" class="width">
  <section id="content" class="two-column with-right-sidebar">  
        ระเบียบวาระที่ <?php echo $_SESSION['noagen5'].": ".$_SESSION['detailagen5']; ?>
<form class="form-inline" action="<?php echo site_url('Template/addsubagen6'); ?>" method="post"> 
  <?php for ($i=0;$i<5;$i++) { ?>
...
<?php    
    if($_SESSION['noagen1']==$_SESSION['stop']){
